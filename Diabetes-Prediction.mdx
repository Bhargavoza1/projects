...
Precision is important when the cost of false positives is high. For example, in medical diagnoses, a high precision is crucial to avoid unnecessary treatments or interventions.
...
Recall is important when the cost of false negatives is high. In situations where failing to identify positive instances has serious consequences, recall becomes a critical metric. This is common in medical diagnoses, where missing a positive case may have severe implications.
