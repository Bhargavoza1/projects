...
diabetes_DS.head()
```
<CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/projects/main/images/Diabetes-Prediction/dshead.png"  alt="biological neuron" height={941} width={234} />

```Python
diabetes_DS.describe()
```
<CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/projects/main/images/Diabetes-Prediction/dsdescribe.png"  alt="biological neuron" height={1000} width={348} />
