...
date: '2024-04-02'
tags: ['ai','neuralnetwork','OpenCV','deeplearning','AKS','Azure','CICD','githubactions','CUDA','C++','Golang','React.js','project']
---
...
github [kidney_tumor_CL_cudaC](https://github.com/Bhargavoza1/kidney_tumor_CL_cudaC)
...
<CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/projects/main/images/cuda_cnn/cicd.png"  alt=""  width={960} height={540} />


# Limitations and possible solutions

## Speed 
My CUDA C++ architecture exhibits high speed, though not as proficient as PyTorch.
**Solution:** Batter to use PyTorch and Python to create neural network architecture.

## Development time
Writing anything from scratch in C++ is time-consuming.
**Solution:** Batter to use PyTorch and Python
