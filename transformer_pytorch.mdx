...
10. **Masking**: When the model is learning to create its own story, it shouldn't cheat and look ahead. Masking is like covering up parts of the story the model hasn't reached yet, so it can only use what it's learned so far.
